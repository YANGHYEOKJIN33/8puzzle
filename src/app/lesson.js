...
export const LESSON = [
  ...
  {
    id: 'step',
    title: '노드를 "확장"해요 (자식 만들기)',
    goal: '이 쪽에서 배울 딱 한 가지는 "확장(expand)"이에요. 배치 하나를 노드(node)라고 하는데, 노드를 하나 꺼내(pop) 거기서 빈칸을 밀어 만들 수 있는 다음 배치를 모두 만드는 일이 "확장"이에요. 이렇게 생긴 자식 노드들이 앞으로 탐색할 후보가 됩니다.',
    todo: '⏭ 한 단계를 눌러 노드를 한 번 확장해 보세요. 아래 "자식 노드" 띠에 지금 배치에서 갈 수 있는 다음 배치가 만들어져요. 빈칸 위치에 따라 자식이 2·3·4개로 달라지는 것도 세어 보세요.',
    layout: 'board',
    stage: 'pseudo',
