...
export const DS_LESSON = [
  ...
  },
  {
    ...
    kind: 'priority',
    view: 'play',
    goal: '앞에서 배운 "큐"를 떠올려 보세요. 우선순위 큐도 큐인데, 나갈 차례를 들어온 순서가 아니라 "우선순위"로 정해요. 여기서는 값이 작을수록 우선순위가 높습니다. (큐를 먼저 알아야 이 차이가 보여요.)',
    todo: '넣기(push)를 눌러 보세요. 나중에 넣은 값이라도 우선순위가 높으면 앞자리에 끼어드는(새치기) 걸 볼 수 있어요. 큐라면 무조건 맨 뒤였겠죠?',
  },
  {
    id: 'ds-compare',
    kind: 'queue',
