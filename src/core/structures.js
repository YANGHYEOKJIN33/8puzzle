...
export const DS_KINDS = [
  ...
  },
  {
    ...
    sub: '응급실',
    icon: '🏥',
    rule: '우선순위가 높은 것이 먼저 나가요 (값이 작을수록 우선순위가 높아요)',
    ruleShort: '우선순위가 높은 것이 먼저',
    ruleEn: 'Priority Queue — 우선순위 값이 작은 것부터',
    story: '응급실과 똑같아요. 온 순서가 아니라 얼마나 급한지(우선순위)로 차례를 정해요. ' +
           '나중에 왔어도 우선순위가 높으면 앞자리에 삽입됩니다.',
    inWord: '우선순위에 맞는 자리에 삽입돼요',
    outWord: '우선순위가 가장 높은 것이 나가요',
    becomes: '최상 우선 탐색 · A*',
