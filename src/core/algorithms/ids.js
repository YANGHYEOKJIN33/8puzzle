...
export const notes = Object.freeze([
  '깊이 한계 L을 0에서 시작해요.',
  'L을 0, 1, 2 … 로 하나씩 늘리며 아래 탐색을 되풀이해요.',
  '한계 L짜리 깊이 우선 탐색을 한 번 돌려요 — 스택만 쓰니 메모리가 적어요.',
  '스택 맨 위에서 노드를 꺼내요.',
  '꺼낸 노드가 목표면 끝! 한계를 조금씩 늘렸으니 이때가 곧 최단 해예요(너비 우선의 장점).',
  '아직 한계보다 얕으면 자식을 만들어 OPEN에 넣어요.',
  'L 안에 없으면 L을 1 늘려 처음부터 다시 — 얕은 곳을 다시 보는 대신 최단성과 적은 메모리를 함께 얻어요.',
]);
